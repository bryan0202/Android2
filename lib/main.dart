  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      body: Container(
        ...
        decoration: BoxDecoration(color: Colors.black, image: DecorationImage(image: NetworkImage('https://raw.githubusercontent.com/bryan0202/fotitas/main/descarga%20(3).jpg'), alignment: Alignment.topCenter) //fin de decoration image
            ), //fin box decoration
